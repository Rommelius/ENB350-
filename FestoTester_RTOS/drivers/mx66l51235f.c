...
MX66L51235FInit(uint32_t ui32SysClock)
{
    ...
    //
    SPIFlashInit(SSI3_BASE, ui32SysClock, ui32SPIClock);
...
MX66L51235FWait(void)
{
    ...
    do
    {
        ...
        //
        ui8Status = SPIFlashReadStatus(SSI3_BASE);
...
MX66L51235FSectorErase(uint32_t ui32Addr)
{
    ...
    //
    SPIFlashSectorErase(SSI3_BASE, ui32Addr);
...
MX66L51235FBlockErase32(uint32_t ui32Addr)
{
    ...
    //
    SPIFlashBlockErase32(SSI3_BASE, ui32Addr);
...
MX66L51235FBlockErase64(uint32_t ui32Addr)
{
    ...
    // Erase the requested block.
    //
    SPIFlashBlockErase64(SSI3_BASE, ui32Addr);
                       ...
                       uint32_t ui32Count)
{
    ...
    //
    SPIFlashPageProgram(SSI3_BASE, ui32Addr, pui8Data, ui32Count);
...
MX66L51235FRead(uint32_t ui32Addr, uint8_t *pui8Data, uint32_t ui32Count)
{
    ...
    //
    SPIFlashRead(SSI3_BASE, ui32Addr, pui8Data, ui32Count);
